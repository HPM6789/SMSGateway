                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="formAuthentication" class="mb-3" action="changePassword" method="POST">
                                <input type="hidden" name="originOldPassword" value="${originOldPassword}"/>
                                <input type="hidden" name="username" value="${username}"/>
                                <div class="mb-3">
                                    <div class="form-password-toggle">
                                        <label class="form-label" for="basic-default-originPassword">Mật Khẩu Cũ</label>
                                        <p id="errorPassword"></p>
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="basic-default-originPassword"
                                                   name="oldPassword" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" 
                                                   required="" value=""
                                                   />
                                            <span id="basic-default-originPassword" class="input-group-text cursor-pointer"
                                ...
                                <div class="mb-3">
                                    <div class="form-password-toggle">
                                        <label class="form-label" for="basic-default-password">Mật Khẩu Mới</label>
                                        <p id="errorPassword"></p>
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="basic-default-password"
                                                   name="newPassword" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" 
                                                   required="" value="" onchange="validatePassword()"
                                                   />
                                    ...
                                    <div class="form-password-toggle">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="basic-default-confirmPassword" name="confirmPassword"
                                                   placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                   required="" onchange="confirmPassword()" value=""/>
                                            <span id="basic-default-password" class="input-group-text cursor-pointer"
                                                  ><i class="bx bx-hide"></i
                                                ></span>
                                        </div>
