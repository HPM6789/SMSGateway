                ...
                <div class="layout-page">
                    <div class="card" style="margin-bottom: 10px; padding: 10px 0 10px 10px;">
                        <form action="searchType" method="get" style="width: 20%" name="searchUserForm">
                            ...
                            <input type="text" name="typeName" placeholder="Tên Loại Dịch Vụ"
                                ...
                                <tbody class="table-border-bottom-0">
                                    <c:forEach var="t" items="${types}">
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTop-${t.typeId}">
                                                    Xóa
                                                </button>

                                                <!-- Modal -->
                                                <div class="modal modal-top fade" id="modalTop-${t.typeId}" tabindex="-1">
                                                    <div class="modal-dialog">
                                                        <form class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        <h2>Bạn có chắc muốn xóa ${t.typeName}</h2>
                                                                    </div>
                                                                </div>
