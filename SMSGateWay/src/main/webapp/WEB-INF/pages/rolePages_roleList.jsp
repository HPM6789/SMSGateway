            ...
            <div class="layout-container">
                ...
                <div class="layout-page">
                    <div class="card" style="margin-bottom: 10px; padding: 10px 0 10px 10px;">
                        <form action="roleList" method="post" style="width: 20%" name="searchUserForm">
                            <input type="text" name="roleName" placeholder="role name"
                                   id="usernameOrEmail" class="form-control" value="${roleName}"/>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive text-nowrap">
                            <a href="addRole?action=add" style="color: inherit; text-decoration: none">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="updateRole?action=update&id=${r.id}"
