                                                ...
                                                <c:if test="${action.equals('update')}">
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3 col-md-6">
                                                            <label for="cpName" class="form-label">Tên Đối Tác</label>
                                                            <input
                                                                class="form-control"
                                                                type="text"
                                                                id="cpName"
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <label for="cpCode" class="form-label">Mã Đối Tác</label>
                                                            <input
                                                                class="form-control"
                                                                type="text"
                                                                id="cpCode"
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <div class="form-password-toggle">
                                                                <label for="passwordMt" class="form-label">Mật khẩu MT</label>
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <label for="listipMt" class="form-label">Danh sách IP MT</label>
                                                            <input
                                                                class="form-control"
                                                                type="text"
                                                                id="listipMt"
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <label for="usernameCharge" class="form-label">Username trừ cước</label>
                                                            <input
                                                                class="form-control"
                                                                type="text"
                                                                id="usernameCharge"
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <div class="form-password-toggle">
                                                                <label for="passwordCharge" class="form-label">Mật khẩu trừ cước</label>
                                                                <div class="input-group">
                                                                    <input
                                                                        class="form-control"
                                                                        type="password"
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <label for="representer" class="form-label">Đại diện</label>
                                                            <input
                                                                class="form-control"
                                                                type="text"
                                                                id="representer"
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <label for="emailCp" class="form-label">Email Đối Tác</label>
                                                            <input
                                                                class="form-control"
                                                                type="text"
                                                                id="emailCp"
